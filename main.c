...
int main (void){
    ...
    // examine_list(lista);
    // listAddFirst(lista, strClone("heyyooooo"));
    // examine_list(lista);
    // listAddFirst(lista, strClone("andre 3000"));
    // examine_list(lista);
    // listAddFirst(lista, strClone("and the guachi"));
    // examine_list(lista);
    // listAddLast(lista, strClone("The Last Jedi"));
    // examine_list(lista);
